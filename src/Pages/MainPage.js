...
export default function MainPage() {
    let mappedemployees = employees && employees.map((employee, index) =>{ //for each employee, run the functions and then pass the result to the EmployeeCards component.
